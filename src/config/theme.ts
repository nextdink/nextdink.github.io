 ...
 *
 * The colors are designed to work with Tailwind CSS and are exported
 * both as a theme object and as CSS custom property names.
 */

// Primary brand color - currently using blue-teal (cyan shifted to 700/800 for better contrast)
// To change: swap these hex values with your desired color palette
export const colors = {
  primary: {
    50: "#ecfeff",
    100: "#cffafe",
    ...
    400: "#22d3ee",
    500: "#0891b2",
    600: "#0e7490", // Main brand color (light mode) - darker blue-teal
    700: "#155e75", // Hover state (light mode)
    800: "#164e63",
    900: "#134e4a",
    950: "#083344",
  },
...
export const backgrounds = {
  light: "#ffffff", // slate-50 alternative: #f8fafc
...
// These are used for generated user avatars
export const avatarGradients = [
  [colors.primary[600], colors.primary[500]], // Primary brand colors (blue-teal)
